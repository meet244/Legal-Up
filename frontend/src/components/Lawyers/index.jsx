      ...
      <div>
        ...
        <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-start justify-between border-b border-gray-200 pb-6 pt-6">
            ...
            <form className="flex-1 ml-8 mr-4"
              onSubmit={(e) => {
                e.preventDefault();
                let { queryStr } = e.target;
                dispatch(setQuery(queryStr.value));
            ...
            <div className="bg-accent p-2 rounded cursor-pointer " onClick={speechToText()}>
              <BiSolidMicrophone size={24} className=" text-white" />
            </div>
          ...
          <section aria-labelledby="products-heading" className="pb-24 pt-6">
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
              ...
              <div className="lg:col-span-3 ">
                {lawyers.loading && <Loader message="Loading Lawyers List..." />}
  ...
  return <>
    < div className="border-b border-gray-200 py-6" >
      <h3 className="-my-3 flow-root">
        <button onClick={() => { setToggle(!toggle) }} type="button" className="flex w-full items-center justify-between bg-white py-3 text-sm text-gray-400 hover:text-gray-500" aria-controls="filter-section-0" aria-expanded="false">
      ...
      {toggle && <div className="pt-6" id="filter-section-0">
        <div className="space-y-4">
          <div className="flex items-center">
            ...
            <label for="filter-color-0" className="ml-3 text-sm text-gray-600">less than 200</label>
          </div>
          <div className="flex items-center">
            ...
            <label for="filter-color-1" className="ml-3 text-sm text-gray-600">200 - 4000</label>
          </div>
          <div className="flex items-center">
            ...
            <label for="filter-color-2" className="ml-3 text-sm text-gray-600">400 - 600</label>
          </div>
          <div className="flex items-center">
            ...
            <label for="filter-color-3" className="ml-3 text-sm text-gray-600">600 - 800</label>
          </div>
          <div className="flex items-center">
            ...
            <label for="filter-color-4" className="ml-3 text-sm text-gray-600">higher than 800</label>
          </div>
        </div>
      </div>}
    ...
    < div className="border-b border-gray-200 py-6" >
      ...
      {toggle && <div className="pt-6" id="filter-section-0">
        <div className="space-y-4">
          <div className="flex items-center">
            <input id="filter-color-0" name="color[]" value="white" type="checkbox" className="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500" />
            <label for="filter-color-0" className="ml-3 text-sm text-gray-600">Medical</label>
          </div>
          <div className="flex items-center">
            <input id="filter-color-1" name="color[]" value="beige" type="checkbox" className="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500" />
            <label for="filter-color-1" className="ml-3 text-sm text-gray-600">Criminals</label>
          </div>
          <div className="flex items-center">
            <input id="filter-color-2" name="color[]" value="blue" type="checkbox" checked className="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500" />
            <label for="filter-color-2" className="ml-3 text-sm text-gray-600">Family</label>
          </div>
          <div className="flex items-center">
            <input id="filter-color-3" name="color[]" value="brown" type="checkbox" className="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500" />
            <label for="filter-color-3" className="ml-3 text-sm text-gray-600">Property</label>
          </div>
          <div className="flex items-center">
            <input id="filter-color-4" name="color[]" value="green" type="checkbox" className="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500" />
            <label for="filter-color-4" className="ml-3 text-sm text-gray-600">Intellectual Property</label>
          </div>
        </div>
      </div>}
    ...
    < div className="border-b border-gray-200 py-6" >
      ...
      {toggle && <div className="pt-6" id="filter-section-0">
        <div className="space-y-4">
          <div className="flex items-center">
            <input id="filter-color-0" name="color[]" value="white" type="checkbox" className="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500" />
            <label for="filter-color-0" className="ml-3 text-sm text-gray-600">English</label>
          </div>
          <div className="flex items-center">
            <input id="filter-color-1" name="color[]" value="beige" type="checkbox" className="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500" />
            <label for="filter-color-1" className="ml-3 text-sm text-gray-600">Marathi</label>
          </div>
          <div className="flex items-center">
            <input id="filter-color-2" name="color[]" value="blue" type="checkbox" checked className="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500" />
            <label for="filter-color-2" className="ml-3 text-sm text-gray-600">Hindi</label>
          </div>
          <div className="flex items-center">
            <input id="filter-color-3" name="color[]" value="brown" type="checkbox" className="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500" />
            <label for="filter-color-3" className="ml-3 text-sm text-gray-600">Japanese</label>
          </div>
          <div className="flex items-center">
            <input id="filter-color-4" name="color[]" value="green" type="checkbox" className="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500" />
            <label for="filter-color-4" className="ml-3 text-sm text-gray-600">German</label>
          </div>
        </div>
      </div>}
