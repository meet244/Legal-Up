        ...
        <div className="-mx-4 flex flex-wrap lg:justify-between">
          <div className="w-full px-4 lg:w-1/2 ">
            <div className="mb-12 max-w-[570px] lg:mb-0">
              <div className="text-3xl text-extrabold font-aquire">Get In Touch With Us</div>

              <div className="my-8 flex w-full max-w-[370px]" >
          ...
          <div className="w-full  px-4 lg:w-1/2 :w-5/12">
            <div className="relative rounded-lg bg-white  text-black p-8 shadow-lg sm:p-12">
              <form autocomplete="off"
                onSubmit={(e) => {
                  e.preventDefault();
                  let { name, email, phone, queryStr } = e.target;
